...
module.exports = {
  ...
  doLogin: async function() {
    ...
    //-- Usuario e Senha
    await components.waitVisible("#logonuidfield");
    await components.inputTextValue("#logonuidfield", constants.PORTAL_SGO_USER);

    await components.waitVisible("#logonpassfield");
    await components.inputTextValue("#logonpassfield", constants.PORTAL_SGO_PASS);
    //-- Captcha
    await components.wait("#mainCaptcha");
    await components.waitVisible("#mainCaptcha");
